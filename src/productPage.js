...
export class ProductPage extends Component {
    ...
    componentDidMount() {
        ...
        /*
        Roting z którego kożystam dodaje po tego komponentu propsa match, ten props match ma w środku parametry, zdefiniowane w rotingu dla tej ścieżki pasującej.
        */
